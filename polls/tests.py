...
def create_question(question_text, days):
    """
    Create a question with the given 'qiestion_text' and published
    the given number of days offset to now (negative for questions
    published in the past, positive for question that have yet to be
    ppublished).
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Question with a pub_date int the future aren't displayed on the index page.
        """
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail view of a question with a pub_date int the future
        retruns a 404 not found.
        """
